...
- **QNA - “행위자(doer)” 와 같은 Manager는 도메인인가요? 서비스인가요? 사용해도 괜찮을까요?**
...
- **Java**
    ...
    public class OrderApplicationService1 {
    	 OrderRepository repository;
    }
    
    ---
    public class OrderApplicationService2 {
    	OrderRepositoryImpl repsotiroy;
    }
