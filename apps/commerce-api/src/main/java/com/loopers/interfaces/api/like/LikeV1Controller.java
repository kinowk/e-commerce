...
public class LikeV1Controller implements LikeV1ApiSpec {
    ...
    public ApiResponse<LikeResponse.Toggle> addLike(
        ...
        LikeInput.Toggle input = new LikeInput.Toggle(userLoginId, productId);
    ...
    public ApiResponse<LikeResponse.LikedProductIds> getLikedProductIds(
        ...
        return ApiResponse.success(LikeResponse.LikedProductIds.from(likeFacade.getLikedProductIds(userLoginId)));
    }
}
